...
> #### Supplementary info
> The reference genome was obtained from ftp://ftp.ensemblgenomes.org/pub/plants/release-39/fasta/brassica_oleracea/dna/Brassica_oleracea.v2.1.dna.toplevel.fa.gz, from which we retained only the
